...
const promotores = [
  { id: 1, razaoSocial: "Arcos Dourados Ltda", nomeFantasia: "McDonald's", cnpj: "40.432.544/0001-47", telefone: "(85) 9947276462", dataCadastro: "12/02/2026", email: "industria@gmail.com", tipoIndustria: "ALIMENTICIA" },
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2">
        <h1 className="text-3xl font-bold text-[#2A362B] tracking-tight">Indústrias</h1>
      </div>
          ...
          <Table>
            <TableHeader className="bg-gray-50">
              <TableRow>
                ...
                <TableHead className="min-w-[150px] font-montserrat font-medium text-xs text-gray-600 uppercase">Descrição ↓</TableHead>
                <TableHead className="font-montserrat font-medium text-xs text-gray-600 uppercase">Razão Social</TableHead>
                <TableHead className="min-w-[150px] font-montserrat font-medium text-xs text-gray-600 uppercase">Nome Fantasia↓</TableHead>
                <TableHead className="min-w-[150px] font-montserrat font-medium text-xs text-gray-600 uppercase">Cnpj</TableHead>
                <TableHead className="min-w-[150px] font-montserrat font-medium text-xs text-gray-600 uppercase">Telefone</TableHead>
                <TableHead className="min-w-[150px] font-montserrat font-medium text-xs text-gray-600 uppercase">Data de Cadastro</TableHead>
                <TableHead className="min-w-[150px] font-montserrat font-medium text-xs text-gray-600 uppercase">Email</TableHead>
                <TableHead className="min-w-[150px] font-montserrat font-medium text-xs text-gray-600 uppercase">Tipo de Indústria</TableHead>
              ...
              {promotores.map((promotor) => (
                <TableRow key={promotor.id} className="hover:bg-gray-50/50">
                  ...
                  <TableCell className="text-gray-500 text-sm">
                    {promotor.razaoSocial}
                  </TableCell>

                  
                  <TableCell className="text-gray-500 text-sm">
                    {promotor.nomeFantasia}
                  </TableCell>
